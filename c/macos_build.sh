...
# Copy necessary resources to the output directory
echo -e "${CYAN}Copying shaders to output directory...${NC}"
mkdir -p bin/shaders
cp shaders/*.spv bin/shaders/

echo -e "${CYAN}Copying fonts to output directory...${NC}"
mkdir -p bin/fonts
cp ../fonts/Inconsolata-Regular.ttf bin/fonts/
